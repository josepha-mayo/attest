...
def _demo(args: argparse.Namespace) -> None:
    ...
    print("  language, glanceable. Worker links render as QR codes for the", flush=True)
    print("  door-step scan. --redact-media exports keep signed digests while", flush=True)
