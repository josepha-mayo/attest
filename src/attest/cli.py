...
def _demo(args: argparse.Namespace) -> None:
    ...
    print("     the same verifier.", flush=True)
    print("  4. Dashboard → 'Integrity posture' — the runtime's self-audit, live:", flush=True)
    ...
    print("  9. attest explain <visit_id> — one record's full provenance, in words", flush=True)
